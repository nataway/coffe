...
<html>
    ...
    <body>
        ...
        <%
            String mes = "";
            if(request.getAttribute("mes")!= null) mes = (String)request.getAttribute("mes");
            ThanhVien tv = (ThanhVien)session.getAttribute("tv");
            int idSanPham = Integer.parseInt(request.getParameter("id"));
            SanPham spct = DAO.getSanPhamById(idSanPham); 
        %>
        <div class="row">
            ...
            <nav class="navbar navbar-default" role="navigation" style="background-color: #FFD700">
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <form class="navbar-form navbar-left" role="search"action="SearchSanPham" method="POST" title="Tìm kiếm tên sản phẩm">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="KhachHangOrderCafe.jsp">Cà phê</a></li>
                                <li><a href="KhachHangOrderBanhNgot.jsp">Bánh ngọt</a></li>
                                <li><a href="KhachHangOrderCockTail.jsp">Cocktail</a></li>
                                <li><a href="KhachHangOrderNuocEp.jsp">Nước ép</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
        ...
        <div class="row" >
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9" id="noidung">
                <div class="row">
                    <div class="col-sm-4">
                            <a class="thumbnail" style="width: 330px; height: 330px;">
                                <img src="<%= spct.getUrl() %>" style="width: 320px; height: 320px;">
                            </a>
                    </div>
                    <div class="col-sm-8">
                        <div>
                            <h2 style="font-family: Inconsolata"><%= spct.getName() %></h2>
                            <div>
                                <ins><%= spct.getPrice() %> VNĐ</ins>
                            </div>  
                            <form action="ThemSanPhamVaoGioHang" method="post">
                                <div>
                                    <label style="float: left; padding-right: 10px;">Số lượng</label>
                                    <input id="numberOfProduct" type="number" class="form-control" name="soLuong" placeholder="0" min="1" style="width: 10%" required/>
                                </div>
                                <input type="hidden" name="idSanPham" value="<%= spct.getId() %>"/>
