    ...
    <body>
        ...
        <div id="noidung" class="col-xs-7 col-sm-7 col-md-7 col-lg-7" >
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Thống kê nhân viên theo số lần phục vụ</div>
                <!-- Table -->
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            ...
                            String sql = "select tbl.Id, tbl.Ten, count(tbl.Id) as SoLanPhucVu "+
                                          " FROM(SELECT tblthanhvien.id as Id, tblthanhvien.ten as Ten, tbldonhang.tenSanPham as TenSP"+ 
