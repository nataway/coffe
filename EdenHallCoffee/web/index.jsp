                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p>
                                            ...
                                            <input id="numberOfProduct" type="number" class="form-control" name="soLuong" placeholder="0" min="1" style="width: 30%;" required/>
                                            <input type="hidden" name="idSanPham" value="<%= i.getId() %>"/>
                                            <button formaction="ThemSanPhamVaoGioHang" type="submit" class="btn btn-primary">Thêm vào giỏ hàng</button>
                                        </p>
                                    </div>
                                </div>
                            </form>
